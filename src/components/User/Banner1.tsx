    ...
    className='text-black bg-primary-blue'>
      <div className="max-w-6xl mx-auto px-4 py-8 md:flex md:items-center md:justify-between md:py-16">
        <div className="md:w-1/2 md:pr-8">
          <h1 className='font-bold text-3xl text-center md:text-start md:text-6xl p-5'>Your instant parking Solution</h1>

          <p className='text-black mt-4 md:text-lg p-5 text-center md:text-start'>Welcome to our Parking Finder project! Say goodbye to circling the block endlessly—our intuitive app locates available parking spaces near you in seconds, making urban parking stress a thing of the past.</p>
