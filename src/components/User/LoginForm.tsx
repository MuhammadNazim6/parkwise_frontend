      ...
      <div className='mt-8 '>
        <form onSubmit={submitHandler}>
          ...
          <div className="mt-8 flex justify-between items-center">
            ...
            <Link to='/user/forgotPassword'> <button type='button' onClick={props.togglePasswordFn} className='font-medium text-base text-secondary-blue hover:scale-[1.02]'>Forgot password?</button></Link>
          </div>
          <div className='mt-4 gap-y-4 flex justify-center items-center'>
            <button type='submit' className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out rounded-xl bg-secondary-blue text-white text-lg font-bold w-11/12 h-11'>Sign in</button>
          </div>
        </form>
